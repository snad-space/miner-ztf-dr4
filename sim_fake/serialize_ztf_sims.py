...
# Edited by Patrick Aleo (Github: patrickaleo) for ZTF
# Only gr (for ZTF)
...
from validutils_zwad.io import save_compressed #Made validutils_zwad for only gr filters
from validutils_zwad.table import parse_lsst_model
...
def main():
    ...
    if args.timed:
        ...
        secs = end - start
        print("ZTF light curves serialized in {:.1f} seconds".format(secs))
